...
#' @examples
#' ##############
#' ptnl(q = c(2,5), n = 6,m=15, l = 2, trial = 100000)
#' # $method
#' # [1] "exact"
#' #
#' # $cdf
...
#' @examples
#' \dontrun{
#' qtnl(p = c(.3,.9), n = 4,m=5, l = 1, exact = "FALSE")
#' # $method
...
#'
#' @examples
#' qtnl.lehmann(p = c(.1,.5,.9), n. = 10,m.=10, l = 1, gamma = 0.5)
#' # [1] 1 3 6
...
#' # [1] 4 4 7 5 3 7 7 4 4 5 5 7 7 3 3
